    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="bg-white border-b border-gray-200 py-4 px-6 flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-[#1E3A5F]">Añadir Nuevo Cliente</h1>
                    <p class="text-sm text-gray-500 mt-1">Crea un perfil de cliente para darle acceso al portal</p>
                </div>
            </div>
        </header>
