    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="bg-white border-b border-gray-200 py-4 px-6 flex items-center justify-between gap-3 flex-wrap">
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div>
                    <h1 class="text-2xl md:text-4xl font-medium text-brand-dark">Configuración del Sistema</h1>
                    <p class="text-sm md:text-base text-gray-500 mt-0.5">Ajustes generales y preferencias</p>
                </div>
            </div>
            <button class="flex-shrink-0 bg-brand-green hover:bg-brand-green-dark text-white px-6 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm">
                Guardar Cambios
            </button>
        </header>
            ...
            <div class="max-w-4xl space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-[0px_1px_3px_rgba(0,0,0,0.05)] border border-gray-100 p-6">
                    ...
                    <div class="flex gap-4">
                        <button class="border-2 border-brand-green bg-[#F5F7FA] px-6 py-3 rounded-xl font-medium text-brand-dark">
                            Tema Claro
                        </button>
