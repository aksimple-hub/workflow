            ...
            <div class="grid grid-cols-2 gap-6 h-full">
                ...
                <div class="bg-white rounded-xl shadow-[0px_1px_3px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden relative group">
                    <div class="absolute inset-0 bg-[#E5E7EB] flex items-center justify-center">
                        <div class="text-center">
                            ...
                            <p class="text-[#1E3A5F] font-medium text-lg">Mapa de Operaciones</p>
                ...
                <div class="bg-white rounded-xl shadow-[0px_1px_3px_rgba(0,0,0,0.05)] border border-gray-100 p-6 overflow-y-auto">
                    ...
                    <form action="{{ route('ordenes.store') }}" method="POST" class="space-y-5">
                        ...
                        <!-- Título -->
                        <div>
                            <label for="titulo" class="block text-sm font-medium text-[#1E3A5F] mb-2">Título de la Orden *</label>
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            ...
                            <!-- Prioridad -->
                            <div>
                                <label for="prioridad" class="block text-sm font-medium text-[#1E3A5F] mb-2">Prioridad *</label>
                        ...
                        <!-- Técnico (Opcional) -->
                        <div>
                            <label for="usuario_id" class="block text-sm font-medium text-[#1E3A5F] mb-2">Asignar Técnico</label>
                        ...
                        <div>
                            ...
                            <textarea id="descripcion" name="descripcion" required rows="4"
                                class="w-full bg-[#F5F7FA] border-2 border-transparent focus:border-[#10B981] rounded-xl p-4 resize-none focus:outline-none transition-colors text-base"></textarea>
                        </div>

                        <!-- Botón de Envío -->
                        <div class="pt-4 border-t border-gray-100">
                            <button type="submit" 
                                class="w-full bg-[#10B981] hover:bg-[#059669] text-white px-8 py-4 rounded-xl shadow-[0px_2px_8px_rgba(16,185,129,0.25)] transition-all duration-200 ease-in-out font-medium text-base">
