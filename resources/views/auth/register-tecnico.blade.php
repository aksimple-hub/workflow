                ...
                <form id="registro-form" method="POST" action="{{ route('register.tecnico.store') }}" enctype="multipart/form-data">
                    ...
                    <div id="step-2" class="step-content hidden">
                        ...
                        <div class="flex flex-col-reverse gap-3 md:flex-row md:items-center md:justify-between mt-8 pt-6 border-t border-gray-100">
                            ...
                            <button type="button" onclick="goToStep(3)" class="w-full md:w-auto bg-brand-green hover:bg-brand-green-dark text-white px-8 py-3 rounded-xl font-bold transition-all flex items-center justify-center gap-2">
                                Siguiente <span class="text-xl leading-none">&rarr;</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="step-3" class="step-content hidden">
                        ...
                        <div class="flex flex-col-reverse gap-3 md:flex-row md:items-center md:justify-between mt-8 pt-6 border-t border-gray-100">
                            <button type="button" onclick="goToStep(2)" class="w-full md:w-auto flex items-center justify-center gap-2 py-3 px-6 rounded-xl border border-gray-200 text-sm font-medium text-gray-600 hover:text-brand-dark hover:border-gray-300 transition-all">
                                &larr; Volver
                            </button>
