<x-guest-layout>
    <div class="flex h-screen overflow-hidden bg-white relative">
        ...
        <a href="{{ route('login') }}" class="lg:hidden absolute top-4 left-4 z-50 flex items-center gap-1.5 text-gray-600 hover:text-brand-green font-medium transition-colors bg-white/90 backdrop-blur-md px-3 py-2 rounded-xl shadow-sm border border-gray-100">
