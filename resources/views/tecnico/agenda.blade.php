...
<div class="flex h-screen bg-[#F5F7FA]">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="bg-white border-b border-gray-200 py-4 px-6 flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl md:text-4xl font-medium text-[#1E3A5F]">Mi Agenda</h1>
        ...
        <main class="flex-1 overflow-y-auto p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-xl shadow-[0px_1px_3px_rgba(0,0,0,0.05)] p-4 md:p-6 flex flex-col md:flex-row md:items-center border border-gray-100 hover:border-[#10B981] transition-all duration-200 ease-in-out gap-4">
                    <!-- Hora Destacada -->
                    <div class="flex items-center gap-4 md:block md:w-32 md:pr-4 md:border-r md:border-gray-200 pb-3 md:pb-0 border-b md:border-b-0 border-gray-100">
                        <span class="text-2xl md:text-3xl font-bold text-[#1E3A5F]">
